# Aggregation: Library
A collection of utility functions and abstractions for use by the Platform Aggregation features. Deployable as either a Maven package or a [Lambda Layer](https://docs.aws.amazon.com/lambda/latest/dg/chapter-layers.html).
...
- [Report a Vulnerability](https://github.com/mytiki/platform-agg-library/security/advisories/new)
